...
def clusterin(file_link,nono):
    ##si = joblib.load('/home/arefin/WebApp/si.pkl')
    si = 0
    ...
    if nono == 1:
        ...
        f = f[si:si+35]
        si = si +35
        joblib.dump(si, 'D:/The Stuffs/Project-480/si.pkl')
    hoe = f['headline']
    h= []
    for i in hoe:
        h.append(i)
    ...
    km = joblib.load('D:/The Stuffs/Project-480/finalmodel6.pkl')
...
def clustering(request):
    ...
    clustered_sentences,clustered_headlines = clusterin('D:/The Stuffs/Project-480/Authentic-48K.csv',20)
...
def prothomalo(request):
    ...
    clustered_sentences,clustered_headlines = clusterin('D:/The Stuffs/Project-480/mysite/blog/scraped_news.csv',1)
